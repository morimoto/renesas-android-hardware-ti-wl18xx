...
using android::hardware::wifi::V1_3::ti::feature_flags::
    WifiFeatureFlags;
using android::hardware::wifi::V1_3::ti::iface_util::WifiIfaceUtil;
using android::hardware::wifi::V1_3::ti::mode_controller::
    WifiModeController;
...
int main(int /*argc*/, char** argv) {
    ...
    android::sp<android::hardware::wifi::V1_3::IWifi> service =
        new android::hardware::wifi::V1_3::ti::Wifi(
            iface_tool,
